######################################################################
# Automatically generated by qmake (2.01a) Sat May 25 10:29:31 2013
######################################################################

LIBS += -ltinyxpath -lglog -lpcap
QMAKE_CXXFLAGS += -std=c++11 -include glog/logging.h
QT += sql
TEMPLATE = app
TARGET = 
DEPENDPATH += . cxxpcap db gui threads utils
INCLUDEPATH += . gui threads cxxpcap utils db
