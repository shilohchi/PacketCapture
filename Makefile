...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu May 16 11:28:45 2013
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PacketCapture1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/PacketCapture1.0.0/ && (cd `dirname .tmp/PacketCapture1.0.0` && $(TAR) PacketCapture1.0.0.tar PacketCapture1.0.0 && $(COMPRESS) PacketCapture1.0.0.tar) && $(MOVE) `dirname .tmp/PacketCapture1.0.0`/PacketCapture1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PacketCapture1.0.0
...
compiler_moc_source_clean:
	-$(DEL_FILE) main.moc
main.moc: main.cpp
	/usr/lib/i386-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) main.cpp -o main.moc
