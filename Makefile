...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sat May 25 03:39:14 2013
...
CXXFLAGS      = -pipe -g -std=c++11 -include glog/logging.h -O2 -Wall -W -D_REENTRANT $(DEFINES)
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4/QtSql -I/usr/include/qt4 -I. -Igui -Ithreads -Icxxpcap -Idb -Iutils -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lpcap -lglog -lQtSql -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PacketCapture1.0.0/ && $(COPY_FILE) --parents cxxpcap/cxxpcap.h cxxpcap/DatalinkInfo.h cxxpcap/InetPacket.h cxxpcap/IPPacket.h cxxpcap/Packet.h cxxpcap/PacketCapture.h cxxpcap/PacketFactory.h cxxpcap/TCPPacket.h cxxpcap/UDPPacket.h cxxpcap/utils.h db/IPacketDetailDAO.h db/MysqlPacketDetailDAO.h db/PacketDetail.h db/PacketDetailDAOFactory.h gui/MainWindow.h threads/PacketConsumerThread.h threads/PacketPool.h threads/PacketProducerThread.h threads/PoolWriter.h threads/TrafficCounter.h utils/errors.h .tmp/PacketCapture1.0.0/ && $(COPY_FILE) --parents main.cpp cxxpcap/DatalinkInfo.cpp cxxpcap/InetPacket.cpp cxxpcap/IPPacket.cpp cxxpcap/Packet.cpp cxxpcap/PacketCapture.cpp cxxpcap/PacketFactory.cpp cxxpcap/TCPPacket.cpp cxxpcap/UDPPacket.cpp db/MysqlPacketDetailDAO.cpp db/PacketDetailDAOFactory.cpp gui/MainWindow.cpp threads/PacketConsumerThread.cpp threads/PacketPool.cpp threads/PacketProducerThread.cpp utils/errors.cpp .tmp/PacketCapture1.0.0/ && $(COPY_FILE) --parents gui/MainWindow.ui .tmp/PacketCapture1.0.0/ && (cd `dirname .tmp/PacketCapture1.0.0` && $(TAR) PacketCapture1.0.0.tar PacketCapture1.0.0 && $(COMPRESS) PacketCapture1.0.0.tar) && $(MOVE) `dirname .tmp/PacketCapture1.0.0`/PacketCapture1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PacketCapture1.0.0
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_PacketProducerThread.cpp moc_TrafficCounter.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_PacketProducerThread.cpp moc_TrafficCounter.cpp
